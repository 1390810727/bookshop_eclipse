	...
	<head>
		...
		<script type="text/javascript">
			...
			function check_ajax()
			{
				...
				var message;
				xmlhttp.open("post","check_seller.sellerLogin",true);
		 ...
		 <div class="login">
			...
			<div class="panel panel-default">
			    ...
			    <div class="panel-body">
			    	<!--form表单-->
			    	<form class="form-horizontal" id="myform" action="/bookshop/loginSeller.sellerLogin" role="form" >
							...
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									...
									<button type="button" class="btn btn-default" id="login">登录</button>
										<a href="/bookshop/seller/sellerRegister.jsp"><button type="button" class="btn btn-default">注册</button></a>
									<a href="#">忘记密码？</a>
								</div>
